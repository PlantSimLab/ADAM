...
networkOpt[1] = 'Select the updating scheme for the functions:<br><input type="radio" name="update_box" value="Synchronous" checked> Synchronous<br/><input type="radio" name="update_box" value="Sequential"> Sequential<br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;- Enter update schedule separated by spaces: <br><center><input type="text" name="update_schedule" size="24"></center></font><hr>Generate state space of<br><input type="radio" name="option_box" value="All trajectories from all possible initial states" checked>All trajectories from all possible initial states, i.e., the complete phase space<br><input type="radio" name="option_box" value="One trajectory starting at an initial state">One trajectory starting at an initial state<br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;- Enter initialization separated by spaces: <br><center><input type="text" name="trajectory_value" size="20"></center>';
