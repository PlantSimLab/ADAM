...
networkOpt[1] = 'Select the updating scheme for the functions:<br><input type="radio" name="update_box" value="Synchronous" checked> Synchronous<br/><input type="radio" name="update_box" value="Sequential"> Sequential<br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;- Enter update schedule separated by spaces: <br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;<input type="text" name="update_schedule" size="24" value="2 3 1"></font><tr class="lines"><td></td></tr>Generate<br><input type="radio" name="option_box" value="All trajectories from all possible initial states" checked>Complete State Space<br><input type="radio" name="option_box" value="One trajectory starting at an initial state">One trajectory starting at an initial state<br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;- Enter initialization separated by spaces: <br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;<input type="text" name="trajectory_value" size="20" value="1 0 2" disabled>';
networkOpt[2] = 'Limit cycle length to search for: <br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;<input type="text" name="limCyc_length" size="2" value="1"><tr class="lines"><td></td></tr>Select the updating scheme for the functions:<br><input type="radio" name="update_box" value="Synchronous" checked> Synchronous<br/><input type="radio" name="update_box" value="Sequential"> Sequential<br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;- Enter update schedule separated by spaces: <br>&nbsp\;&nbsp\;&nbsp\;&nbsp\;<input type="text" name="update_schedule" size="24" value="2 3 1" disabled></font>';
