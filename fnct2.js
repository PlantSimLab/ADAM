...
messages[7] = new Array('<b>Large Networks</b>: calculates fixed points and limit cycles up to length 5 for large networks, or for n > 10.', "#DDECFF")
messages[8] = new Array('<b>Conjunctive/Disjunctive Network</b>: if you have a system with only AND functions or only OR functions and check this box then all limit cycles will be calculated quickly', "#DDECFF")
/*if (document.images) {
