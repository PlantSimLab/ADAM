cp steptutorial_files/* ../../htdocs/no-ssl/steptutorial_files/
cp -r models/* ../../htdocs/no-ssl/models/
cp adam.js ../../htdocs/no-ssl/
cp adam.html ../../htdocs/no-ssl/

cp adam_style.css ../../htdocs/no-ssl/
...
cp repository.html ../../htdocs/no-ssl/repository.html
